...
const ChatMessageModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'status': PropertySchema(
      ...
      name: r'status',
      type: IsarType.byte,
      enumMap: _ChatMessageModelstatusEnumValueMap,
    ),
...
ChatMessageModel _chatMessageModelDeserialize(
  ...
  final object = ChatMessageModel(
    ...
    status: _ChatMessageModelstatusValueEnumMap[
...
P _chatMessageModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (_ChatMessageModelstatusValueEnumMap[
              reader.readByteOrNull(offset)] ??
          ChatMessageStatus.sent) as P;
    case 5:
...
const _ChatMessageModelstatusEnumValueMap = {
  'sent': 0,
  'pending': 1,
  'streaming': 2,
  'failed': 3,
...
const _ChatMessageModelstatusValueEnumMap = {
  0: ChatMessageStatus.sent,
  1: ChatMessageStatus.pending,
  2: ChatMessageStatus.streaming,
  3: ChatMessageStatus.failed,
  4: ChatMessageStatus.incomplete,
};
...
extension ChatMessageModelQueryFilter
  ...
  QueryBuilder<ChatMessageModel, ChatMessageModel, QAfterFilterCondition>
      statusEqualTo(ChatMessageStatus value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'status',
        value: value,
...
extension ChatMessageModelQueryProperty
  ...
  QueryBuilder<ChatMessageModel, ChatMessageStatus, QQueryOperations>
      statusProperty() {
    return QueryBuilder.apply(this, (query) {
...
const _$ChatMessageStatusEnumMap = {
  ...
  ChatMessageStatus.incomplete: 'incomplete',
};
